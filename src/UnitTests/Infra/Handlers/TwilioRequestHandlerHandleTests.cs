...
public class TwilioRequestHandlerHandleTests
{
    ...
    public async Task Handle_ShouldReturnNull_WhenTwilioIsNotEnabled()
    {
        ...
        var twilioConfiguration = new TwilioConfiguration { Enable = false, ApiKey = "TestApiKey", ApiKeySecret = "TestApiKeySecret", AccountSid = "TestSid", Fields = "caller_name,line_type_intelligence,sim_swap,live_activity" };
